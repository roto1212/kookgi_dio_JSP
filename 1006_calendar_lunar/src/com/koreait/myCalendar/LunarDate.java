...
public class LunarDate {
	// 월별 음양력 크롤링 사이트: https://astro.kasi.re.kr/life/pageView/8
	...
	private boolean lunarFlag;	// 음력의 윤달 여부를 기억하는 변수
	private String lunar;		// 양력과 음력의 공휴일을 기억하는 변수
	...
	public String toString() {
		return String.format("양력 %04d년 %02d월 %02d일은 %s 음력 %04d년 %02d월 %02d일입니다. - %s", 
