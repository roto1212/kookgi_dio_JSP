...
<%
	//lib 폴더에 commons-dbcp-1.4.jar, commons-dbcp-1.5.7.jar 파일을 복사해서 넣는다. => commonDBCP 드라이버 클래스 src 폴더에 *.jocl 파일을 작성한다. => pool.jocl 파일을 복사해 넣는다. => 데이터베이스 연결정보 
