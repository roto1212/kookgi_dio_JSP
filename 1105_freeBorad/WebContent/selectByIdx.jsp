...
//		메인글 1건을 얻어오고 분기할 페이지 이름(job)을 받는다.
...
//		job에 contentView가 넘어왔을 경우 메인글에 댓글 목록을 얻어와서 request 영역에 저장시킨다.
...
//		increment.jsp에서 넘어온 경우 조회수를 증가시킨 메인글 1건을 브라우저에 출력한 페이지(contentView.jsp)로 넘겨준다.
//		contentView.jsp에서 넘어온 경우 수정 또는 삭제할 글 1건을 브라우저에 보여주는 페이지(update or delete.jsp)로 넘겨준다.
